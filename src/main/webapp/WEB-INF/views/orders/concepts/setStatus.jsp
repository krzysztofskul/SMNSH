        ...
        <div class="container">
            <div class="card">
                <div class="card-header text-center">
                    <p class="langPL">USTAW STATUS ZAMÓWENIA PROJEKTU KONCEPCJI</p>
                    <p class="langEN">SET THE STATUS OF THE CONCEPTUAL PROJECT</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 text-right">
                            <p class="langPL">WYBIERZ NOWY STATUS</p>
                            <p class="langEN">CHOOSE NEW STATUS</p>
                        </div>
                        <div class="col-6">
                            <form:select path="status" cssClass="w-75">
